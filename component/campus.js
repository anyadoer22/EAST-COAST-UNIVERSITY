...
class campusSection extends HTMLElement{
    connectedCallback(){
        ...
        <p>The East Coast University's main campus is located on Richfield Avenue. Surrounded by green space, the main campus is divided into residential and academic buildings connected by a bridge that overlooks the north branch of the Volta River, known to us as Volta Lake.</p>
        <!-- campus-Card -->
