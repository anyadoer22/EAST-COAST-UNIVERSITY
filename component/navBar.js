...
class navSection extends HTMLElement{
    connectedCallback(){
        ...
        <div class="container-ham">
          <div id="brand" class="logo"><img src="./Photos/East Coast University-logos_white.png" alt="Logo"></div>
      ...
      <div class="overlay-content">
       <div class="logo"><img src="./Photos/East Coast University-logos_white.png" alt="Logo"></div>
       <div class="nav-links">
          <ul class="links">
              <li><a href="index.html">Home</a></li>
              <li><a href="about-us.html">About us</a></li>
